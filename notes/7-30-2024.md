...
the results of this one were extremely good and started to go above and beyond my now limited expectations


"now do an overhaul similarly on just the css for the navbar"
...
.navbar a:hover,
.navbar a.active {
    background-color: #37475a; /* Darker blue for hover and active states */
    color: #fff;
}
...
.navbar .badge {
    background-color: #e94e77; /* Eye-catching color for the badge */
    color: white;
    border-radius: 50%;
    padding: 5px 10px;
    font-size: 12px;
...
now we're cooking. when setup to be flexible with style changes, it becomes far easier